...
export const ProfileScreen: React.FC<ProfileScreenProps> = ({
  ...
  const [leaveType, setLeaveType] = useState<"full_day" | "half_day">(
    "full_day",
  );
  const [leaveSession, setLeaveSession] = useState<"morning" | "afternoon">(
    "morning",
  );
  ...
  const handleReportIssue = async () => {
    ...
    try {
      ...
      showZenToast(
        `Report Submitted. ID: #${Math.floor(Math.random() * 9000) + 1000}`,
        "success",
      );
    } catch (err) {
  ...
  const renderSection = (title: string, items: MenuItem[]) => (
    <View style={styles.section}>
      <Text
        style={[styles.sectionTitle, { color: isDark ? "#FFFFFF" : "#1E293B" }]}
      >
        {title}
      </Text>
      <View
    ...
    <View style={styles.container}>
      ...
      >
        ...
        {renderSection("App Settings", [
          ...
          {
            icon: "pause-circle",
            label: "Pause Class Reminders",
            isToggle: true,
            toggleValue: remindersPaused,
            onToggle: async (val: boolean) => {
              setRemindersPaused(val);
              await AsyncStorage.setItem('@attend_me/reminders_paused', val.toString());
              if (val) {
                await NotificationService.cancelAllScheduled();
                showZenToast('Class reminders paused', 'warning');
              } else {
        ...
        {renderSection("Data & Cloud", [
          {
            ...
            label: "Sync Manager",
            value: "Check Status",
            onPress: () => (navigation as any).navigate("SyncManager"),
            color: "#10B981",
          },
        ])}
        ...
        {renderSection("Help & Support", [
          ...
          },
          {
            ...
            onPress: () => (navigation as any).navigate("BeaconDoctor"),
            color: "#10B981",
          },
          {
            icon: "warning",
      ...
      >
        <View style={styles.modalOverlay}>
          <View
            style={[
              styles.modalCard,
              { backgroundColor: isDark ? "#082020" : "#FFF" },
            ]}
          >
            <Text
              style={[
                styles.modalTitle,
                { color: isDark ? "#FFF" : "#082020" },
              ]}
            >
              Apply for Leave
            </Text>
            ...
            {/* Leave Type Toggle */}
            <View
              style={{ flexDirection: "row", marginBottom: verticalScale(16) }}
            >
              ...
              {leaveType === "full_day" ? (
                <View style={{ flexDirection: "row", gap: scale(12) }}>
                  <View style={{ flex: 1 }}>
                    ...
                    >
                      <Text style={{ color: isDark ? "#FFF" : "#082020" }}>
                        {leaveFrom.toLocaleDateString()}
                      </Text>
                    </TouchableOpacity>
                  </View>
                  <View style={{ flex: 1 }}>
            ...
            <TextInput
              ...
              multiline
              placeholder="I am taking leave because..."
        ...
        <View style={{ flex: 1, backgroundColor: "#0F766E" }}>
          ...
          <View
            style={[
              styles.modalHeader,
              {
                marginTop: insets.top + verticalScale(20),
          ...
          <View
            style={{
              flex: 1,
              backgroundColor: isDark ? "#082020" : "#F1F5F9",
                ...
                <View>
                  ...
                  {(() => {
                    ...
                    const uniqueSlots = new Map<
                      string,
                      { start: string; end: string; sortKey: string }
                    >();
                    timetable.forEach((t) => {
                                    ...
                                    >
                                      {hasClass ? (
                                        <>
                                          ...
                                          >
                                            {slotData.target_dept} • Y
                                            {slotData.target_year} •{" "}
                                            {slotData.target_section}
                                            {slotData.room
                                              ? ` • ${slotData.room}`
                                              : ""}
                                          </Text>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Ionicons
                  name={helpTopic ? "arrow-back" : "close"}
                  size={normalizeFont(24)}
                  color="#FFF"
                />
              </TouchableOpacity>
                ...
                {helpTopic === "home" && (
                  <>
                    <View style={{ marginBottom: 24 }}>
                      ...
                      >
                        The **Home Screen** is designed to give you instant
                        access to your classes without clutter.
                      </Text>
                    </View>
                    ...
                    >
                      ...
                      >
                        ...
                        {"\n\n"}• **Current Class**: Highlighted with a large
                        card at the top. This represents the class happening
                        *right now*. Tap anywhere on this card to immediately
                        open the Attendance Scanner. {"\n"}• **Upcoming
                        Classes**: Listed below with time slots (e.g., 10:00 AM
                        - 11:00 AM). You can tap these to view details or
                        request a swap ahead of time. {"\n"}• **Past Classes**:
                        Dimmed out to indicate completion.
                      </Text>
                    </View>
                    ...
                    >
                      ...
                      >
                        It is vital to know if your attendance data is reaching
                        the server. {"\n\n"}• **Cloud Icon (Solid)**: You are
                        online. All changes sync instantly. {"\n"}• **Cloud Icon
                        (Slashed)**: You are offline. Don't worry, the app
                        automatically saves everything to local storage. It will
                        push the data to the server the moment you reconnect.
                      </Text>
                    </View>
                  </>
                )}
                ...
                {helpTopic === "myclass" && (
                  <>
                    <View style={{ marginBottom: 24 }}>
                      ...
                      >
                        The **My Class Hub** is a dashboard specifically for
                        Class Incharges. It provides a bird's-eye view of your
                        assigned class's performance.
                      </Text>
                    </View>
                    ...
                    >
                      ...
                      >
                        ...
                        {"\n"}• **Avg Attendance**: The class average for the
                        current semester.
                      </Text>
                    </View>
                    ...
                    >
                      ...
                      >
                        • **Watchlist**: Automatically flags students with low
                        attendance (below 75%). Tap a student card to send a
                        warning notification. {"\n"}• **Weekly Trends**: A graph
                        showing attendance patterns over the last 7 days. Use
                        this to identify low-attendance days (e.g., Fridays or
                        Mondays).
                      </Text>
                    </View>
                  </>
                ...
                {helpTopic === "notifs" && (
                  <>
                    <View style={{ marginBottom: 24 }}>
                      ...
                      >
                        The **Notifications Screen** is where collaboration
                        happens. It handles all incoming requests and system
                        alerts.
                      </Text>
                    </View>
                    ...
                    >
                      ...
                      >
                        When a colleague Requests a Swap or Substitution, a
                        dedicated card appears at the top. {"\n\n"}• **ACCEPT**:
                        By tapping this, you agree to take their class. The
                        schedule is automatically updated for both of you.{" "}
                        {"\n"}• **DECLINE**: Removes the request. The requester
                        will be notified that you are unavailable.
                      </Text>
                    </View>
                    ...
                    >
                      ...
                      >
                        ...
                        Enter "Selection Mode". Tap multiple items and delete
                        them all at once.
                      </Text>
                    </View>
                  </>
                ...
                {helpTopic === "swaps" && (
                  <>
                    <View style={{ marginBottom: 24 }}>
                      ...
                      >
                        The **Swap System** is a formal way to exchange classes
                    ...
                    >
                      ...
                      >
                        ...
                        {"\n\n"}• **Sent Requests**: See if your requests have
                        been Accepted, Declined, or are still Pending. {"\n"}•
                        **Received Requests**: Review classes you have taken for
                        others. This is useful for year-end reporting.
                      </Text>
                    </View>
                  </>
                )}
                ...
                {helpTopic === "history" && (
                  <>
                    <View style={{ marginBottom: 24 }}>
                      ...
                      >
                        The **History Screen** acts as your digital register,
                        archiving all classes you have conducted.
                      </Text>
                    </View>
                    ...
                    >
                      ...
                      >
                        Every time you submit attendance (Manual or Scan), a
                        permanent log is created. {"\n"}• **Details**: Tap any
                        specific date to see the list of students
                        present/absent. {"\n"}• **Editing**: You generally
                        cannot edit past logs once synced, but you can view them
                        for reporting.
                      </Text>
                    </View>
                    ...
                    >
                      ...
                      >
                        • **Sections**: Logs are grouped by "Today",
                        "Yesterday", "This Week", and "Older". {"\n"}•
                        **Offline**: These logs are cached locally, so you can
                        view your teaching history even without internet.
                      </Text>
                    </View>
                  </>
                )}
                ...
                {helpTopic === "profile" && (
                  <>
                    ...
                    >
                      ...
                      >
                        Your official ID. **Note**: For security, this card is
                        now only available when you are online to ensure
                        verification of active status. Offline access has been
                        disabled.
                      </Text>
                    </View>
                    ...
                    >
                      ...
                      >
                        • **Apply for Leave**: Submits a formal leave request to
                        the HOD. Note that you should still arrange
                        substitutions for your classes using the Swap feature.{" "}
                        {"\n"}• **Report Issue**: If you encounter a bug, use
                        this to attach a screenshot and send it to our dev team.
                      </Text>
                    </View>
                  </>
                )}
        ...
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            <Text
              style={[
                styles.inputLabel,
                { color: isDark ? "#FFF" : "#0F172A", marginBottom: 6 },
              ]}
            >
              ISSUE DESCRIPTION
            </Text>
