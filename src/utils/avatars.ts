...
export const FallbackAvatars = [
  ...
  require('../../assets/Userpics/Cranks-1.png'),
  require('../../assets/Userpics/Cranks-2.png'),
  require('../../assets/Userpics/Cranks.png'),
  require('../../assets/Userpics/Funny Bunny-7.png'),
  require('../../assets/Userpics/Funny Bunny.png'),
  require('../../assets/Userpics/Guacamole-1.png'),
  require('../../assets/Userpics/Guacamole-2.png'),
  require('../../assets/Userpics/Guacamole-3.png'),
  require('../../assets/Userpics/Guacamole.png'),
  require('../../assets/Userpics/Juicy-1.png'),
  require('../../assets/Userpics/Juicy.png'),
  require('../../assets/Userpics/No comments 4.png'),
  require('../../assets/Userpics/No comments 5.png'),
  ...
  require('../../assets/Userpics/Teamwork-5.png'),
  require('../../assets/Userpics/Teamwork-6.png'),
  require('../../assets/Userpics/Teamwork-7.png'),
  require('../../assets/Userpics/Teamwork-8.png'),
  require('../../assets/Userpics/Teamwork.png'),
  require('../../assets/Userpics/Upstream-1.png'),
  require('../../assets/Userpics/Upstream-10.png'),
  require('../../assets/Userpics/Upstream-11.png'),
  require('../../assets/Userpics/Upstream-12.png'),
  require('../../assets/Userpics/Upstream-14.png'),
  require('../../assets/Userpics/Upstream-15.png'),
  ...
  require('../../assets/Userpics/Upstream-6.png'),
  require('../../assets/Userpics/Upstream-7.png'),
  require('../../assets/Userpics/Upstream-8.png'),
  require('../../assets/Userpics/Upstream-9.png'),
